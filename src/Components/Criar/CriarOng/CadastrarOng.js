...
import DefaultImage from "../../../resources/images/cadastrar-usuario-ong.png";
...
const CadastrarOng = () => {
  ...
  async function handleSubmit() {
    if (validaParteUm() && validaParteDois()) {
      const { url, options } = CADASTRAR_INSTITUICAO({
      ...
      <div className={style.containerFormulario}>
        ...
        >
          <form action="" className={style.camposUsuario}>
            <p>Preencha seus dados para criar um perfil de Instituição.</p>
            <Input
              id="nome"
              label="Nome Fantasia: "
              type="text"
            ...
            <div className={style.conjuntoInput}>
              <Input
                ...
                {...documento}
              />
              <Input id="date" label="Data de Criação:" type="date" {...date} />
            </div>
            <Input
              id="razaoSocial"
              label="Razão Social:"
            ...
            <div className={style.conjuntoInput}>
              <Input id="senha" label="Senha:" type="password" {...senha} placeholder={'minimo 8 caracteres'} />
              <Input
                id="senha2"
          ...
          <div className={style.containerImg}>
            <ul className={style.informacaoFoto}>
              <li>Sua Instituição online para todos os doadores.</li>
              <li>Anúncie todos os items de que precisa.</li>
              <li>Crie um perfil e comece a compartilhar sua causa.</li>
            </ul>
            <div
              className="userImage"
              style={{
        ...
        >
          ...
          <form action="" className={style.camposUsuario + ` animeRight`}>
